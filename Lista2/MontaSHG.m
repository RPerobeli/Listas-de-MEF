...
switch grau
    ...
    case 4
        ...
        for i = 1:nint
            ...
            shg(2,1,i) = 2.66667*(t^3 -0.75*t^2 - 0.125*t + 0.0625);
            shg(2,2,i) = -10.6667*(t^3 -0.375*t^2 - 0.5*t + 0.125);
            shg(2,3,i) = 16*(t^3 - 0.625*t);
            shg(2,4,i) = -10.6667*(t^3 +0.375*t^2 - 0.5*t - 0.125);
            shg(2,5,i) = 2.66667*(t^3 +0.75*t^2 - 0.125*t - 0.0625);
        end
