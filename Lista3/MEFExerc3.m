...
%% Plot funcao e aproximacao
    figure;
    plot(x_global,alfa,'b', x_ex,funcao(x_ex,1.25),'r');
    nome = num2str(nel);
...
%% Plot da funcao exata para testes
figure;
plot(x_ex,funcao(x_ex,0),'r');
frase = 'Funcao exata - testes';
title(frase);
xlabel('x');
ylabel('f(x)');