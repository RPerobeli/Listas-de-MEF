...
h_el = h/grau;
x_global = xi:h_el:xf;
%% Transforma̤oes para elemento de referencia
    ...
    for l = 1:nint
        ...
        for j = 1:nen
            ...
            for i = 1:nen
                ...
                Ke(i,j) = Ke(i,j)+ (eps+artificial)*shg(2,i,l)*1/dx*shg(2,j,l)*1/dx*w(l)*dx;
